...
it's not clear they are being used in practice any more. On the other hand, the QKV method seems to
still be used extensively. See [An Overview of Attention | Papers With Code](
...
QKV lets you easily connect two different modalities because e.g. QK can both be text and V can be
an image (image search in web browsers). See point `5.` in [What's the difference between Attention
vs Self-Attention? - DSSE](https://datascience.stackexchange.com/a/66431/26431).
