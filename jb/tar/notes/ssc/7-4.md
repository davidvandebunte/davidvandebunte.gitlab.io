...
<!-- ![x](raster/2023-11-24T14-26-58.png) delete-me -->

> **Upshot: Truth values are open sets.** The point is that the truth values in the topos of sheaves on a space $(𝑋, \textbf{Op})$ are the open sets of that space. When someone says “is property $𝑃$ true?,” the answer is not yes or no, but “it is true on the open subset $𝑈$.” If this $𝑈$ is everything, $𝑈 = 𝑋$, then $𝑃$ is really true; if $𝑈$ is nothing, $𝑈 = ∅$, then $𝑃$ is really false. But in general, it’s just true some places and not others.
...
See [Seven Sketches § Definition 7.69](https://gitlab.com/applied-category-theory/seven-sketches/uploads/33f290d229d6e2a7f3d9a7454b839580/7Sketches.pdf#section.7.4):
