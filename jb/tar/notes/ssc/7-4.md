...
Compare to the definition in Proposition 2.98.

+++

An arguably simpler definition than (7.57), from [Heyting algebra § Examples](https://en.wikipedia.org/wiki/Heyting_algebra#Examples):
