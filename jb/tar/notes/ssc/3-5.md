...
See [Universal property § Examples § Products](https://en.wikipedia.org/wiki/Universal_property#Products) for a similar definition. How does this article's commutative diagram relate to the author's? The commutative diagram provided in the text:
