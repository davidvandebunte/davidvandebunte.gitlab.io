...
You're likely already using the term limit in the sense of [Limit (mathematics)](https://en.wikipedia.org/wiki/Limit_(mathematics)). Per that article the concepts are related:
...
See also [Limit § Mathematics](https://en.wikipedia.org/wiki/Limit#Mathematics).
