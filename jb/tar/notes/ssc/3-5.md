...
![x](raster/definition-3-86-part1.png)

+++

![x](raster/definition-3-86-part2.png)
...
It's possible to get through the next two exercises (and this chapter) without understanding what is meant by the constraints on the arrows. See [Universal property § Limits and colimits](https://en.wikipedia.org/wiki/Universal_property#Limits_and_colimits) for a more detailed definition.
...
![x](raster/example-3-99-part1.png)

+++

![x](raster/example-3-99-part2.png)
