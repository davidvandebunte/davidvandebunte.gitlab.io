...
![x](raster/2023-10-29T23-48-33.png)
...
![x](raster/2023-10-29T23-51-20.png)

+++

![x](raster/2023-10-29T23-52-45.png)
...
![x](raster/2023-10-29T23-53-16.png)

+++

![x](raster/2023-10-29T23-53-35.png)
...
![x](raster/2023-10-29T23-53-58.png)
...
:class: dropdown
![x](raster/2023-11-04T17-07-49.png)
```

+++

![x](raster/2023-10-29T23-56-18.png)
...
![x](raster/2023-10-29T23-54-25.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-10-07.png)
```
...
![x](raster/2023-10-29T23-57-41.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-12-35.png)
```

+++

The author's answer seems confused; he asks for two functors in the question and gives four in the answer.

+++

![x](raster/2023-10-29T23-58-10.png)
...
![x](raster/2023-10-30T00-01-58.png)
...
![x](raster/2023-10-30T00-03-25.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-14-56.png)
```
...
The author seems to avoid defining "contravariant" functors, instead defining standard (covariant) functors on opposite categories. See [Functor § Covariance and contravariance](https://en.wikipedia.org/wiki/Functor#Covariance_and_contravariance):
...
![x](raster/2023-10-30T00-06-28.png)

+++

![x](raster/2023-10-30T00-06-47.png)
...
![x](raster/2023-10-30T00-07-09.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-15-29.png)
```

+++

![x](raster/2023-10-30T00-08-11.png)

+++

![x](raster/2023-10-30T00-08-37.png)
...
![x](raster/2023-10-30T00-09-51.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-20-14.png)
```

+++

![x](raster/2023-10-30T00-10-14.png)
...
![x](raster/2023-10-30T00-11-42.png)

+++

Prerequisite to [Natural transformation](https://en.wikipedia.org/wiki/Natural_transformation) (this article uses $\eta$ for natural) and [Functor category](https://en.wikipedia.org/wiki/Functor_category). A good way to think about a
natural transformation between two functors is that we define it (its existence) in terms of its effects; because functors are like functions (defined in terms of what they do) all we can do is look at the effects (in category 𝓓). It's similar to but opposite to defining a function in terms of data (e.g. collected data).
...
![x](raster/2023-10-30T00-12-12.png)
...
You can use a commutative diagram to express that a particular category (say the category of real numbers) is commutative. Notice that in $ab = ba$ that the a and b become morphisms. However, you can also use a commutative diagram to express that a particular category is associative; a commutative diagram is provided at the top of the article [Associative property][wap]. Notice in the article [Commutative Diagram -- from Wolfram MathWorld][wolfis] a much shorter (and likely more memorable) version of Definition 3.28 (of an isomorphism). For a more complicated example with the diagram and algebra side-by-side, see [abstract algebra - Why gives a commutative diagram a proof?](https://math.stackexchange.com/questions/295648/why-gives-a-commutative-diagram-a-proof).
...
Functors are designed to transform commutative diagrams in C to commutative diagrams in D, see [Functor / Properties - Wikipedia](https://en.wikipedia.org/wiki/Functor#Properties).

To draw or update commutative diagrams on Wikipedia, see [Help:Displaying a formula - Commutative diagrams - Wikipedia](https://en.wikipedia.org/wiki/Help:Displaying_a_formula#Commutative_diagrams). For documentation on tikzcd, see [tikzcd: Commutative diagrams with TikZ - tikz-cd-doc.pdf](https://ctan.math.washington.edu/tex-archive/graphics/pgf/contrib/tikz-cd/tikz-cd-doc.pdf).

To get started quickly, see [quiver: a modern commutative diagram editor](https://q.uiver.app/) (partially selected based on [star history](https://star-history.com/#varkor/quiver&yishn/tikzcd-editor&Date)). You can use overleaf to export the drawing, as in [tikzcd export](https://www.overleaf.com/read/bmxtjphrstcw). If you have the necessary dependencies on your local machine, see [tikzcd-export · GitLab](https://gitlab.com/davidvandebunte/tikzcd-export).

+++

![x](raster/2023-10-30T00-12-58.png)
...
![x](raster/2023-10-30T00-13-18.png)
...
![x](raster/2023-10-30T00-13-39.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-23-25.png)
```

+++

![x](raster/2023-10-30T00-14-16.png)
...
![x](raster/2023-10-30T00-15-35.png)
...
![x](raster/2023-10-30T00-16-01.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-24-34.png)
```
...
![x](raster/2023-10-30T00-16-24.png)
...
### An arrow category is a functor category

Let's try to understand the article [Functor category](https://en.wikipedia.org/wiki/Functor_category) better from one more example. From [Functor category § Examples](https://en.wikipedia.org/wiki/Functor_category#Examples):

> An arrow category $\mathcal{C}^\rightarrow$ (whose objects are the morphisms of ${\mathcal {C}}$, and whose morphisms are commuting squares in ${\mathcal {C}}$) is just $\mathcal{C}^\mathbf{2}$, where 2 is the category with two objects and their identity morphisms as well as an arrow from one object to the other (but not another arrow back the other way).

See [Comma category § Arrow category](https://en.wikipedia.org/wiki/Comma_category#Arrow_category) for that definition. Taking $\mathcal{C}$ to be the commutative square (section 3.2.2), one functor between $\mathbf{2}$ and $\mathcal{C}$ is:

![x](arrow-category-is-functor-category.svg)
...
Which we could write as a relation as $\{(1,A), (2,C)\}$. A short list of notable functors between these categories:
...
Clearly there's a natural transformation from $F$ to $I$ and from $G$ to $H$ (and vice-versa, making both natural isomorphisms). These are the morphisms of the functor category, the natural transformations of the original category, or the commuting squares in the arrow category:

![x](arrow-category-is-functor-category-2.svg)

If we had taken $\mathcal{C}$ to be the free square (section 3.2.2) then both η and ε would have been "infranatural" or "unnatural" transformations.
...
![x](raster/2023-10-30T00-50-20.png)

+++

![x](raster/2023-10-30T00-51-06.png)
...
![x](raster/2023-10-30T00-51-34.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-25-21.png)
```

+++

![x](raster/2023-10-30T00-52-08.png)

+++

![x](raster/2023-10-30T00-53-17.png)

+++

![x](raster/2023-10-30T00-53-43.png)
...
![x](raster/2023-10-30T00-54-07.png)
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-11-04T17-25-45.png)
```
