...
See also [Preservation (disambiguation)](https://en.wikipedia.org/wiki/Preservation); this word doesn't seem to have a strict mathematical definition. The more widely used word seems to be [Invariant (mathematics)](https://en.wikipedia.org/wiki/Invariant_(mathematics)); this sentence from that page clearly matches two of the examples above:

> The [distance](https://en.wikipedia.org/wiki/Distance "Distance") between two points on a [number line](https://en.wikipedia.org/wiki/Number_line "Number line") is not changed by [adding](https://en.wikipedia.org/wiki/Addition "Addition") the same quantity to both numbers. On the other hand, [multiplication](https://en.wikipedia.org/wiki/Multiplication "Multiplication") does not have this same property, as distance is not invariant under multiplication.
