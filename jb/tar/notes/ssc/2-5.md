...
In terms of wiring/string diagrams or proofs, one could read this as the rule that if $a$ and $v$ holding means that $w$ also holds, then it's also the case that $a$ holding means that if $v$ holds then $w$ holds. Visually:
...
:class: dropdown
![x](raster/2023-10-28T18-37-34.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-38-09.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-39-50.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-38-44.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-39-04.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-42-25.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-44-08.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-44-40.png)
```
