...
An equation equivalent to (2.80) is given at the start of [Heyting algebra](https://en.wikipedia.org/wiki/Heyting_algebra). The reasoning behind the choice of ⊸ (named multimap in the unicode standard, or `\multimap` in latex) for Heyting implication is mentioned in [Heyting algebra § Category-theoretic definition](https://en.wikipedia.org/wiki/Heyting_algebra#Category-theoretic_definition).
