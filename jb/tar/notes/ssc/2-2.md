...
:class: dropdown
![x](raster/2023-10-28T17-43-10.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T17-43-36.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T17-44-37.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-07-23.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-08-22.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-10-26.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-10-52.png)
```
...
In the following table we use 0 for no, 0.5 for maybe, and 1 for yes:
...
The `min` function is associative; see [Associative property - Examples][ape]. The `yes` element can be used as a monoidal unit. It's easy to see the symmetry/commutativity property is satisfied in the truth table.
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-12-02.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-12-44.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-13-36.png)
```
...
See also [Extended real number line](https://en.wikipedia.org/wiki/Extended_real_number_line), referenced in [Pointed set](https://en.wikipedia.org/wiki/Pointed_set).
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-14-01.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-15-01.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-15-36.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-15-59.png)
```
...
```{admonition} Reveal 7S answer
:class: dropdown
![x](raster/2023-10-28T18-17-16.png)
```
